<?php
namespace Webresso\SecurityKit;


/**
*  A scaptcha class class
*
*  This class is used for managing captcha in PHP
*
*  ABDEL RAHMAN KARIM
*/
class Captcha {
	...
	public function render_captcha() {
		...
		if (extension_loaded ( "gd" )) {
			...
			@imagettftext ( $im, 20, 0, 11, 21, $grey, $this->font_dir . "times_new_yorker.ttf", $this->code );
				
				
				// Add the text
				@imagettftext ( $im, 20, 0, 10, 20, $red, $this->font_dir . "times_new_yorker.ttf", $this->code );
